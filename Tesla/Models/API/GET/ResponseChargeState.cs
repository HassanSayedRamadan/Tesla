...
{
    public class ResponseChargeState
    {
        ...
        public string charge_port_cold_weather_mode { get; set; }
        ...
        public string managed_charging_start_time { get; set; }
